...
<body style="background-color:#F7EBFD; padding-top: 120px;">
    <!-- Navbar -->
    ...
    <section id="facilities" class="bg-dark text-light py-5 px-3 p-lg-5 text-center text-sm-start">
        <div class="container pt-5 ">
            ...
            <div class="d-sm-flex align-items-center justify-content-around">
                <div>
                    <h1>Facilities</h1>
                    <p class="lead my-4">Apelo Dental Clinic is utlizing 2nd and 3rd level of Apelo Bldg 8271 allowing us to provide enough facilities needed by the patients. Lobby area enough to handle 16 patients, a dedicated operating area and more.
                    </p>
                </div>
                <!-- Carousel -->
                <div id="demo" class="carousel slide my-3" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="images/operatingRoom.jpg" alt="Operating Room" class="d-block" style="width:100%; transform: none;">
                        </div>
                        <div class="carousel-item">
                            <img src="images/lobbyView1.jpg" alt="Lobby 1" class="d-block" style="width:100%; transform: none;">
                        </div>
                        <div class="carousel-item">
                            <img src="images/lobbyView2.jpg" alt="Lobby 2" class="d-block" style="width:100%; transform: none;">
                        </div>
                    </div>
