...
?>
    ...
    <body style="padding-top: 120px; padding-bottom: 120px;">
        ...
        <h1 class="text-primary fw-bold text-center">Xray</h1>
        <div class="container">
            <?php
            ...
            if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit'])) {
                ...
                if (is_uploaded_file($tmp_name)) {
                    ...
                    $path = 'uploads/xrays/' . $name;
                    if (move_uploaded_file($tmp_name, $path)) {
                        // Save the image information to the database
                        $sql = "INSERT INTO xray (name, type, size, path, caption, patiendID) VALUES ('$name', '$type', '$size', '$path', '$caption', '$userid')";
                ...
                header('Location: xray.php?uid=' . $userid);
            }
            ?>
            <!-- HTML form for uploading an image -->
            <div class="row py-4">
                <h3 class="text-primary">Add New Xray</h3>
            ...
            $sql = "SELECT * FROM xray WHERE patiendID = $userid";
                    ...
                    <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
                        <div class="carousel-inner">
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                echo '<p class="text-primary pt-0 pb-1 my-0"><b>Date : </b>' . date('F d, Y', strtotime($row['timeCreated'])) . '</p>';
